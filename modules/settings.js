...
const argv = require('yargs')
    ...
    .option({
        ...
        pirlpath: {
            demand: false,
            describe: 'Path to Pirl executable to use instead of default.',
            requiresArg: true,
            nargs: 1,
            type: 'string',
            group: 'Mist options:',
        ...
        '': {
            describe: 'To pass options to the underlying node (e.g. Pirl) use the --node- prefix, e.g. --node-datadir',
            group: 'Node options:',
        },
    })
    .help('h')
